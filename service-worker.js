const ENTRELINHAS_SW_VERSION='1.0.29-v490';
const CACHE_NAME='entrelinhas-pwa-1-0-29-v490';
...
self.addEventListener('fetch',event=>{
  ...
  /* Supabase, Google, R2, Workers e CDNs ficam sempre fora do cache da PWA. */
